  ...
  return (
    <section className="relative flex items-center justify-center px-4 lg:px-6 overflow-hidden bg-section-cta reveal-on-scroll" style={{ paddingTop: "clamp(48px, 6vw, 80px)", paddingBottom: "clamp(48px, 6vw, 80px)" }}>
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 50%, rgba(0,136,255,0.25), transparent 50%), radial-gradient(circle at 50% 50%, rgba(0,212,255,0.2), transparent 70%)",
        }}
      />
      <div className="relative mx-auto max-w-5xl text-center">
        ...
        >
          <Link
            to="/contact"
            className="group inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#00D4FF] via-[#0088FF] to-[#0050A0] px-8 py-5 text-base font-medium shadow-[0_20px_80px_-15px_rgba(0,212,255,0.6)] hover:scale-[1.03] transition-all"
          >
            Book Consultation
